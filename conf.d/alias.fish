#!/bin/fish
	...
	# Reload qbittorrent and Plex to free swap memory
	    alias reload-apps='sudo systemctl stop qbittorrent plexmediaserver && sudo snap stop tautulli && sudo systemctl start qbittorrent plexmediaserveri && sudo snap start tautulli'
